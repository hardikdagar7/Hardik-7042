[Hardik-7042] Operating Details
====================================

Generated On: 2024-10-17 20:09:58 UTC
...
.. important::
   ...
   **not be valid if your [Hardik-7042] container is NOT running**.

.. tip::
   You must have your [Hardik-7042] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/hardikdagar7/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=37053  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='hardikdagar7'  \-\-env DOCKERUSERNAME='hardikdagar0207'  \-\-env MQTTUSERNAME='hardikdagar0207'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   hardikdagar0207/Hardik-7042-amd64 (https://hub.docker.com/r/hardikdagar0207/Hardik-7042-amd64)
...
.. important::
   docker run -d -p 49031:49031 -p 32889:32889 -p 54963:54963 \-\-env TSS=0 \-\-env SOLUTIONNAME=Hardik-7042 \-\-env SOLUTIONDAG=solution_preprocessing_dag-Hardik-7042 \-\-env GITUSERNAME=hardikdagar7  \-\-env GITREPOURL=https://github.com/hardikdagar7/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=49031  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=32889  \-\-env SOLUTIONVIPERVIZPORT=54963 \-\-env DOCKERUSERNAME='hardikdagar0207'  \-\-env EXTERNALPORT=37053 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='hardikdagar0207' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  hardikdagar0207/Hardik-7042-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=54963
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=49031
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - hardikdagar0207/Hardik-7042-amd64
...
It can be accessed by entering: http://localhost:32889
...
.. important::
   http://localhost:54963/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:54963/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:54963/<html file>
...
[Hardik-7042] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/hardikdagar7/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/Hardik-7042
...
.. important::
   https://Hardik-7042.readthedocs.io
...
.. important::
   solution_preprocessing_dag-Hardik-7042
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=49031, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=36303, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=35583, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=37143, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=42859, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=38385, HPDEHOST=127.0.1.1, HPDEPORT=46691, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=43377

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7303-Hardik-7042,solution_preprocessing_dag-Hardik-7042, python-preprocess-7479-Hardik-7042,solution_preprocessing_dag-Hardik-7042, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
